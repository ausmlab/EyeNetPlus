...
from tester_YU import ModelTester
from helper_ply import read_ply
from tool import DataProcessing as DP
from tool import ConfigYU as cfg
...
class YU:
    def __init__(self):
        ...
        self.all_splits = [i for i in range(24)]
        self.val_split = 1

        # Initial training-validation-testing files
        self.all_files = np.sort(glob.glob(join(self.path, 'original_files', '*.las')))
        #self.val_file_name = ["5165_54395", "5180_54435", "5180_54485",
        #                      "5185_54390", "5185_54485", "5190_54400"]
        
        self.val_file_name = ["618175.81_4846250.00__618775.81_4846850.00",
    ...
    def load_sub_sampled_clouds(self, sub_grid_size):
        ...
        for i, file_path in enumerate((self.all_files)):
            ...
            sub_features = np.vstack((data['intensity'], data['n_return'])).T
            ...
            #print(self.input_trees['training'][i].shape)
